...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="mxztar-wheel-routing-") as temporary:
        ...
        require(
            ...
            "page scrolling is the default mouse-wheel mode",
        )
        require(
        ...
        require(
            str(window.settings.value(WHEEL_MODE_SETTING))
            == WHEEL_MODE_SCROLL_CTRL_ZOOM,
            "the selected mouse-wheel mode persists in application settings",
        )
